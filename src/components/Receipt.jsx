      ...
      <div className="modal">
        ...
        <div className="content">
          <div className="orderDetails">
            <table className="orderWrapper">
              <tr>
                ...
                <th className="mruEats">INSTANT EATS</th>
                <th className="dateOrdered">
                  {formatDate(props.order?.dateOrdered, true)}
                </th>
              </tr>
            </table>
          ...
          <div className="footer">
            ...
            <div className="appreciationMessage">
              Thank you for choosing INSTANT Eats!!
            </div>
          </div>
        </div>
